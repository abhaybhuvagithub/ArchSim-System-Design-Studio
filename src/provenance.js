...
const P = {
  ...
  ledger: { cls: 'modeled', refs: [R.pg], basis: 'Append-only double-entry writes are fsync-bound, not CPU-bound: a durably-committed insert pair on cloud block storage lands in the low thousands per second per node. Batching commits raises it and widens the loss window - the classic trade this component refuses by default.' },
