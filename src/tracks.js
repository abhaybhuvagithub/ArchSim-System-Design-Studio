...
export const TRACKS = [
  {
    ...
    stages: [
      ...
      { t: 'Reliability & operations', areas: ['reliability', 'obs-sec', 'deploy'], tpl: 'Flipkart (Big Billion Days)' },
  ...
  },
  {
    ...
    stages: [
      ...
      { t: 'Releases & migrations', areas: ['deploy'], tpl: 'Card Payments (Auth + Settlement)' },
      { t: 'Reliability engineering', areas: ['reliability'], tpl: 'Netflix' },
      { t: 'Observability & security', areas: ['obs-sec'] },
  ...
  },
  {
    ...
    stages: [
      ...
      { t: 'Ship it like software', areas: ['deploy'] },
    ],
  ...
  },
  {
    ...
    stages: [
      ...
      { t: 'Ship & operate', areas: ['deploy', 'reliability'] },
    ],
