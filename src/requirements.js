...
const RULES = [
  ...
  [/gateway api|canary rollout|weighted traffic|traffic split/i,   'k8sgw',      'Kubernetes Gateway API'],
  [/grpc-json|json transcod/i,                                    'grpcgw',     'gRPC-JSON Transcoder'],
  [/\bgrpc\b|protobuf|binary rpc/i,                                'grpc',       'gRPC Service'],
