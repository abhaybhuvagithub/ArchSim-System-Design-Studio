...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    body: `${TEMPLATES.length} worked designs live here, Bharat first — UPI Switch, Zomato, Card Payments, Telemedicine, Ayurveda Gyaan — then WhatsApp, Uber, Netflix, ChatGPT and the rest. Pick one to study it, or start from a blank canvas. Loading one now so the rest of the tour has something to show.`,
    load: 'Ticketmaster',
    marquee: true,
  },
  {
  ...
  },
  {
    ...
    body: 'The twenty-three areas that carry most system design interviews - networking and identity through analytics, data engineering, capacity & cost engineering and production LLM drills - itemized into 112 tracked concepts, with roadmap.sh tracks and a JD planner mapping paths and postings onto them, each with its 🎤 as-asked phrasing and every area with its 🚩 red flag — each with a teaching line, an inline ⇄ Compare table where the concept is a trade-off, and a ▶ Practice button that lands on the exact template and control. Shuffled every visit, because positional memory is the enemy of review. And turn on \ud83e\udd4a Defend It: it hides every answer behind its question so you PRODUCE the reasoning before you see it \u2014 recall is what turns reading into the ability to defend a design in a room, and it is the single highest-return way to study here.',
    tab: 'mastery',
  },
  {
    id: 'llm-drills',
  ...
  },
  {
    ...
    title: 'Acronyms',
    body: 'Every abbreviation the studio uses — over a hundred, from CAP to UPI to FHIR — expanded once, searchable, and categorised. The tax on jargon, paid in full.',
    tab: 'acr',
  },
  {
    id: 'share',
  ...
  },
  {
    ...
    body: 'Ctrl+K, ⌘K, or the ⌘ button in the header opens the command palette: load any template, jump to any tab, or open a mastery concept where it is practiced — grouped into categories with chips to filter. The fastest way around nineteen tabs.',
  },
  {
    id: 'hld-lld',
    target: '[data-tour="tab-hld"]',
    title: 'HLD and LLD — computed, not copied',
    body: 'Two altitudes of the same design. HLD times the request path live — every hop at its current utilization, the user-felt budget, the capacity worksheet with headroom, and failure modes read from this graph. LLD renders schemas, sequence flows and state machines with live latencies on every step. Drag the traffic slider and watch both move.',
    tab: 'hld',
  },
  {
    id: 'dac',
    target: '[data-tour="tab-code"]',
    title: 'Diagrams as code — in and out',
    body: 'The Code tab exports any design as Mermaid (READMEs on GitHub, Notion and Obsidian render it natively) or as an Excalidraw file for the interview whiteboard — and paste any Mermaid flowchart back in and it becomes a live simulation, component types inferred from names. Other tools draw the picture; this one runs it.',
    tab: 'code',
  },
  {
    id: 'arrange',
