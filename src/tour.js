...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    body: 'The twenty-two areas that carry most system design interviews - networking and identity through analytics, data engineering, expert frameworks and production LLM drills - itemized into 107 tracked concepts, with roadmap.sh tracks and a JD planner mapping paths and postings onto them, each with its 🎤 as-asked phrasing and every area with its 🚩 red flag — each with a teaching line, an inline ⇄ Compare table where the concept is a trade-off, and a ▶ Practice button that lands on the exact template and control. Shuffled every visit, because positional memory is the enemy of review. And turn on \ud83e\udd4a Defend It: it hides every answer behind its question so you PRODUCE the reasoning before you see it \u2014 recall is what turns reading into the ability to defend a design in a room, and it is the single highest-return way to study here.',
    tab: 'mastery',
  },
  {
    id: 'llm-drills',
