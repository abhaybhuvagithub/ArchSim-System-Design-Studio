...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    body: 'The thirteen areas that carry most system design interviews - the arithmetic and production LLM drills included - itemized into 49 tracked concepts — each with a teaching line, an inline ⇄ Compare table where the concept is a trade-off, and a ▶ Practice button that lands on the exact template and control. Shuffled every visit, because positional memory is the enemy of review.',
    tab: 'mastery',
  },
  {
    id: 'acronyms',
