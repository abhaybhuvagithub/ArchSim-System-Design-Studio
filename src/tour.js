...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    body: 'The twenty areas that carry most system design interviews - networking and identity through analytics, data engineering, customer engineering and production LLM drills - itemized into 93 tracked concepts, with roadmap.sh tracks and a JD planner mapping paths and postings onto them, each with its 🎤 as-asked phrasing and every area with its 🚩 red flag — each with a teaching line, an inline ⇄ Compare table where the concept is a trade-off, and a ▶ Practice button that lands on the exact template and control. Shuffled every visit, because positional memory is the enemy of review.',
    tab: 'mastery',
  },
  {
    id: 'llm-drills',
