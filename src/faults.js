...
export const FAULTS = [
  ...
  { id: 'retry', icon: '🔁', name: 'Retry Storm', group: 'Distributed', scope: 'node', prefer: ['ledger', 'sql', 'queue', 'gateway', 'micro'], secs: 20,
    ...
    hint: 'Retries are duplicates wearing a disguise. Idempotency keys make them harmless replays; without them, every timeout mints phantom work — and on a ledger, phantom money. Budget the storm into your headroom.',
    fix: { kind: 'scale' },
