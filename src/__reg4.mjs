...
for (const t of TEMPLATES) {
  ...
  const d = describeArchitecture({ nodes, edges, rps: t.rps, sim, cost, cap: capacityReport(nodes, sim), sugs: review(nodes,edges,t.rps), faults: [], fx: null, template: t, cloud: 'aws', simOn: true })
